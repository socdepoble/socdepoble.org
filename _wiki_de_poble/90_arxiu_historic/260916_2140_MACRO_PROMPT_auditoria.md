...
| Camp | Valor |
| --- | --- |
| Identificador | SDP-PROMPT-202609161940 |
| Versió | 1.0.0 |
| Entorn | entorn-dev-local |
| Creació | 2026-09-16 19:40 |
| Modificació | 2026-09-16 19:40 |
...
- `260916_2140_MACRO_BUNDLE_auditoria.md` · sha256 del manifest: 386bcd331be41f4529af4d3365a6f33abfaccd5f95a5911141e1b58f96a6372e
...
El sistema requereix una auditoria d'arquitectura inversa, destructiva i constructiva, per trobar qualsevol forat possible. Es tracta d'una cerca implacable de vulnerabilitats i problemes de disseny.

## Situació i dades opaques

Bundle aparellat: 260916_2140_MACRO_BUNDLE_auditoria.md. (Aquest bundle és gran, 3.3MB. Si la teva interfície l'ha tallat i no veus el sentinella <<<FI_DEL_BUNDLE>>>, analitza fins on pugues arribar i centra't en l'arquitectura de les carpetes 'src', 'tooling' i en trobar forats de seguretat, friccions i incompatibilitats.)

Sollutia s'ha de connectar amb nosaltres i la pàgina ha de ser perfectament segura i robusta.

## Missió

1. Fes una auditoria extrema, destructiva i constructiva, sobre l'arquitectura inversa del projecte.
2. Identifica tots els forats de seguretat potencials, defectes lògics o vulnerabilitats.
3. Analitza la integració amb Sollutia i busca incompatibilitats ocultes.
4. Si el bundle està tallat, avalua el manifest i els fitxers que has pogut llegir. Demana a l'usuari (el Mestre) qualsevol fitxer extra que et falte i siga clau per a trobar forats de seguretat o problemes d'integració.
5. Siguis despietat en la crítica, però precís i basat exclusivament en l'evidència del bundle adjunt.
