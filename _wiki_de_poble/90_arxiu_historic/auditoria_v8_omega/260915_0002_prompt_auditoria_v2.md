...
Auditar el paquet auditoria_v2 amb evidències verificables

`OBJECTIU: Auditar el paquet auditoria_v2 amb evidències verificables`

## Context Necessari

Bundle aparellat: 260915_0002_BUNDLE_auditoria_v2.md.
...
Ets membre del Consell (en concret Claude o Codex, tot i que açò s'aplica a tota IA auditora). El teu objectiu és l'excel·lència absoluta: no vull conformitat, vull que DESTROSSES el codi actual aplicant arquitectura inversa per trobar qualsevol problema latent i solucionar-lo de qualsevol tipus.

`EXECUTA: Analitza el codi i la Wiki adjunts, identifica causes i proposa solucions. Passa per SEO, accessibilitat, l'estructura, les skills, els tractors, les portes, i dóna una visió de futur amb solucions per a codi que puga durar "1000 anys" sota els principis de Pedra Seca. Has de ser impecable i trobar problemes ocults que no hagin passat altres auditories. Volem anar a Sollutia amb la cara ben alta. Fes-ho tot verificable.`
