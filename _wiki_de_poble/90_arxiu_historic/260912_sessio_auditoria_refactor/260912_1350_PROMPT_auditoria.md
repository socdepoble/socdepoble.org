...
Auditoria integral implacable (Sistema de disseny, SEO, Accessibilitat i Qualitat) preparatòria per a Sollutia.

`OBJECTIU: Auditoria integral implacable (Sistema de disseny, SEO, Accessibilitat i Qualitat) preparatòria per a Sollutia`

## Context Necessari

Bundle aparellat: 260912_1350_BUNDLE_auditoria.md.
...
El Consell ha de ser implacable. Teniu via lliure per destruir, reconstruir i posar a prova l'arquitectura. Heu de ficar-vos als skills, adaptar la personalitat de la IAIA i esbrinar on falla tot. Hem de millorar-ho absolutament tot abans d'integrar-nos amb Sollutia. Cal auditar a fons tots els nivells: el sistema de disseny (Pedra Seca), l'accessibilitat universal (a11y), el SEO tàctic i l'elegància del codi. No deixeu pedra sobre pedra.

### Foc creuat: Estandardització de Targetes (UI)
Poseu atenció especial a resoldre el deute tècnic sobre la `UniversalCard`:
1. Cal unificar l'estètica de les targetes del Panell de Control i de l'Onboarding.
2. Definir una variant clara per a targetes d'acció/navegació (més "clicables", potser amb franja taronja) versus targetes informatives.
3. Estandarditzar l'alineació dels títols: centrat per defecte, o alineat a l'esquerra si porten icona. Valoreu-ne la coherència per a tot el sistema.

`EXECUTA: Analitza el codi i els skills adjunts, sigues implacable en la crítica de disseny, accessibilitat i SEO, i proposa canvis radicals però ben fonamentats.`
