...
| Camp | Valor |
| --- | --- |
| Identificador | SDP-PROMPT-202609160108 |
| Versió | 1.0.0 |
| Entorn | entorn-dev-local |
| Creació | 2026-09-16 01:08 |
| Modificació | 2026-09-16 01:08 |
...
- `260916_0308_BUNDLE_auditoria.md` · sha256 del manifest: 0748baaa0983a2f9a8524db0e57fbab677cbbd5354e2d6dcf5e8ae57248456bd
...
Bundle aparellat: 260916_0308_BUNDLE_auditoria.md.
...
**Aquest és un prompt per a l'Equip Macro (Macro-arquitectura). Tens tot el codi font a la teua disposició (Macro-Bundle).**

1. **Auditoria Extrema:** Bombardejar el sistema per fer arquitectura inversa i trobar forats de seguretat, SEO, usabilitat i defectes en la integració amb Sollutia. L'objectiu és "Zero problemes" a la reunió.
2. **Neteja del Cervell de les IAs:** Actualment tenim 80 etiquetes inútils i massa variables (categories) que embruten la memòria del projecte. Et demane que m'aconselles **quines categories i etiquetes esborrar**. La Wiki i les skills han d'estar netes per a mantindre la meua lucidesa.
3. **El Tractor d'Auto-Categorització:** Dissenya una idea/arquitectura d'un nou script (un *tractor*) que permeta que el cervell de les IAs s'entenga de forma més humana, autorrelacionant conceptes i que **aprenga a autoetiquetarse i autocategoritzarse** (sense necessitat que l'humà pose les etiquetes a mà) segons el text de la skill, adoptant en tot moment la personalitat de la IAIA MarIA.

## Eixida esperada

Genera un dictamen en format markdown dividit en:
- Troballes d'Arquitectura/SEO/Seguretat
- Proposta de purga de categories/etiquetes
- Disseny del Tractor d'Auto-Categorització
