...
## === FITXER 1/4: tooling/brain/crear_bundle.mjs ===
<<<HASH: 39701597a868639b6a6fd872da4cb5fc9bec7f3c5ad6e1d8ac4d9140bbe1c8cb>>>
#!/usr/bin/env node
/**
...
## === FITXER 2/4: tooling/wiki/lib/prompt_iso.mjs ===
<<<HASH: a7807b6485adcc2a728ad0c94547e1724b3e7fe3a71697f3969c83833aabeaf5>>>
import fs from 'node:fs';
import path from 'node:path';
import { createHash } from 'node:crypto';
...
## === FITXER 3/4: scripts/generate-bundle-v4.sh ===
<<<HASH: 8b5b8ecc4ec655182618bbc7ef8001dee3129b5721c652d7b2c29f33cd772f26>>>
#!/usr/bin/env bash
#
...
PATRO_MORTS='\.(orig|rej|bak|swp)$|\.abans-[0-9]{6}$|\.antic$|~$'
...
declare -a DIRS_IGNORATS=(node_modules .git .hg .svn dist build coverage .vite .next .nuxt .cache .turbo .obsidian .DS_Store bot/.iaia_auth)
...
## === FITXER 4/4: _wiki_de_poble/02_saber/07_plantilles/00_PLANTILLA_PROMPT_ISO.md ===
...
## === TANCAMENT ===
## fitxers_emesos: 4/4
## manifest_sha256: bd114b6f486a112a356125f4886f142764854b78ed3d6a5e3e58681c99f289be
<<<FI_DEL_BUNDLE>>>
