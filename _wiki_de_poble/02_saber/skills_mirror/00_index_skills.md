...
# Índex de Skills (El Cervell Executiu)

> [!IMPORTANT]
> L'autoritat executiva (les **Skills** que els agents llegeixen per operar) viu exclusivament en aquest directori (`.agents/skills/`). 
> D'altra banda, els documents teòrics i les normes del passat han estat reubicats a `_wiki_de_poble/02_saber/protocols_tecnics/` per evitar contaminació cognitiva. Aquests últims són *fitxes de coneixement*, no eines executables.
