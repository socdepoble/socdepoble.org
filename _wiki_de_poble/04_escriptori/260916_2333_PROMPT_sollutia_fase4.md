...
| Camp | Valor |
| --- | --- |
| Identificador | SDP-PROMPT-202609162133 |
| Versió | 1.0.0 |
| Entorn | entorn-dev-local |
| Creació | 2026-09-16 21:33 |
| Modificació | 2026-09-16 21:33 |
...
- `260916_2333_BUNDLE_null.md` · sha256 del manifest: 9540a68f4559259ff2e2874d05a98b55e72f2a367e5203f392eac4777196e635
...
S'ha completat la Fase 2 i 3 de la reestructuració del Sistema de Disseny (Pedra Seca).
S'han eliminat antigues carpetes ui/ i s'ha adoptat una estructura atòmica (atoms/, molecules/, organismes/, composicio/). S'han creat macro-contenidors estructurals (Pila, Fila, Graella, Costat, Centre, Superficie) per no haver d'utilitzar flex o margin manualment de manera constant.
S'ha netejat i adaptat el tokens.css deixant exclusivament 3 elevacions i 3 radis.

## Situació i dades opaques

Bundle aparellat: 260916_2333_BUNDLE_null.md.
...
1. Verifica exhaustivament els fitxers a `src/components/PedraSeca/` i `src/css/`. 
2. Realitza una auditoria extrema (mode ulleres roges) buscant defectes d'arquitectura a la capa atòmica, col·lisions d'estils amb la reestructuració de macro-contenidors i trencaments als arxius modificats (`tokens.css`, `components.css`, i l'adaptació d'imports).
3. Busca forats de seguretat, defectes en la integració amb Sollutia, trencaments de les normes del "Trellat" i "Pedra Seca", i assegura't que l'aïllament per instància de configuració es manté segur. Informe de forma destructiva qualsevol fallida en els components i contenidors CSS nous.
