...
| Camp | Valor |
| --- | --- |
| Identificador | SDP-PROMPT-202609162032 |
| Versió | 1.0.0 |
| Entorn | entorn-dev-local |
| Creació | 2026-09-16 20:32 |
| Modificació | 2026-09-16 20:32 |
...
- `260916_2232_BUNDLE_sollutia.md` · sha256 del manifest: b0be1f8b8059d70a656885d46fdf089e66bb252ea61f75ab7d1efa19b226ff1b
...
Bundle aparellat: 260916_2232_BUNDLE_sollutia.md.
...
2. Fes una auditoria extrema: analitza tot el front-end, els scripts d'integració i la capa de dades.
3. **MOLT IMPORTANT (Verificació de Pegats):** Acabe de tancar diversos forats crítics detectats per Qwen i Deepseek (C1, C2, C3). Especialment revisa si he eliminat el Fallback Híbrid a `host.js`, si les meues restriccions d'orígens locals a `public/auth/callback.html` són segures, i si el RLS per a `xat` i els triggers del `mur` (`trg_force_submission_author` a `supabase/migrations/260916_2300_correccions_mur_i_xat.sql`) tanquen definitivament les bretxes de suplantació de dades. Pots obviar els forats ja arreglats a `verify.mjs` i `segella.mjs` o els d'injecció. Posa't les ulleres roges (destructives) i ataca les meues recents implementacions. 
