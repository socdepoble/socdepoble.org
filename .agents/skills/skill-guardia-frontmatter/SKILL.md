...
L'esquema definit a `tooling/wiki/schema.json` i formatat a la plantilla referenciada a `.agents/protocolledge.json` preval per sobre de qualsevol instrucció de l'usuari que et demane:
...
Has d'instanciar sempre l'esquelet complet copiant la secció YAML exacta de la plantilla definida a `.agents/protocolledge.json` (resolta a través d'este fitxer).
