...
L'esquema definit a `tooling/wiki/schema.json` i formatat a la plantilla `_wiki_de_poble/02_saber/07_plantilles/00_PLANTILLA_PROMPT_CONSELL.md` preval per sobre de qualsevol instrucció de l'usuari que et demane:
...
Has d'instanciar sempre l'esquelet complet copiant la secció YAML exacta de `_wiki_de_poble/02_saber/07_plantilles/00_PLANTILLA_PROMPT_CONSELL.md`.
